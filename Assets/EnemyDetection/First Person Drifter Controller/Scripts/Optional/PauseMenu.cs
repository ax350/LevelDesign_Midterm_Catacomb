...
public class PauseMenu : MonoBehaviour
{
	...
	private MouseLook_FPDC camMouseLook;
	private MouseLook_FPDC capsuleMouseLook;
	...
	void Start ()
	{
		...
		camMouseLook = Camera.main.GetComponent<MouseLook_FPDC>();
		capsuleMouseLook = GameObject.FindWithTag("Player").GetComponent<MouseLook_FPDC>();
